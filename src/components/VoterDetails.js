...
export default function VoterDetails() {
    ...
    useEffect(() => {
      ...
      return (
        <div>
          <VoterDataSummary data={totalRow}  id="voter-data-summary"></VoterDataSummary>
          <FormControl className="segment-select-control">
            <InputLabel data-testid="segment-select-label">Segment</InputLabel>
            <Select
            ...
            <TableContainer sx={{ maxHeight: 500 }} data-testid="voter-details-section">
